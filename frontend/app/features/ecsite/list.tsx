...
export default function SearchForm({ allProducts, onSubmit }: Props) {
  ...
  return (
    ...
    >
      <Command className="rounded-lg border shadow-md h-auto max-h-[150px] overflow-y-auto 
...
<CommandInput
        ...
        {query && (
            <CommandList>
        <CommandEmpty>該当する商品が見つかりません</CommandEmpty>
        <CommandGroup heading="Suggestions" >
            {products.map((product) => (
                <CommandItem key={product.name} value={product.name}>
